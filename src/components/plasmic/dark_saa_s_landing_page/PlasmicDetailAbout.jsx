...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: S7zjyjDQCWGB/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__k8T3X)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__k2AFm)}>
            <h5
